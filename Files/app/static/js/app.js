...
const TOUR_STEPS = [
  ...
  { tab: "console",     selector: '[data-tab="console"]',     title: "RCON Console",   text: "Live feed of everything your server logs. Run any RCON command, broadcast messages to all players, and click your saved Quick Command bubbles below the input for one-tap shortcuts." },
  ...
  { tab: "chat",        selector: '[data-tab="chat"]',        title: "Chat Logs",      text: "Live capture of all in-game player chat from the RCON stream. Filter by player name, SteamID, or message text instantly — keeps up to 500 messages while the dashboard is running." },
  ...
  { tab: "settings",    selector: '[data-settings-section="profile"]',       title: "Settings — Profile",        text: "Set your admin username — it's attached to every note, ban, and kick you make so other admins know who took the action. Required before the dashboard can be used.", setup: "profile" },
  ...
  { tab: "settings",    selector: '[data-settings-section="quick-commands"]', title: "Settings — Quick Commands",  text: "Create your own one-tap shortcut bubbles for the RCON Console. Give each one a label and a command — they appear as clickable pills below the console input.",   setup: "quick-commands" },
